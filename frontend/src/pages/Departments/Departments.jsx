...
const Departments = () => {
    const { departments, positions, loading, setDepartments } = useDepartments();
    ...
    return (
        <div className="p-6 relative">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                >
                    <PlusCircle size={18} /> Add Departments
                </button>
            </div>
            ...
            <div className="flex justify-center mt-4 gap-2">
                {Array.from({
                    length: Math.ceil(sortedDepartments.length / itemsPerPage),
                }).map((_, i) => (
                    <button
                        key={i}
